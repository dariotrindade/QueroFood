    ...
    before((done) => {
        usuarioModel.remove({ nome: /.*usuario mocha.*/i }, () => {
            ...
            let usuario = new usuarioModel({
                nome: 'usuario mocha',
                email: 'usuariomocha@querofood.com',
                senha: md5('123'),
            ...
            usuario.save().then(() => {
                ...
                chai
                    ...
                    .send({ email: 'usuariomocha@querofood.com', senha: '123' })
                    .end((error, response) => {
    ...
    describe('/POST', () => {
        it('Registra novo usuário', (done) => {
            chai
                ...
                .send({
                    nome: 'usuario mocha',
                    email: 'usuariomocha1@querofood.com',
                    senha: '123',
                ...
                .end((err, res) => {
                    ...
                    res.body.should.have.property('email').eql('usuariomocha1@querofood.com');
                    done();
                });
        });
        it('Autentica o novo usuário cadastrado', (done) => {
            chai
                .request(server)
                .post('/api/usuario/autenticar')
                .send({ email: 'usuariomocha1@querofood.com', senha: '123' })
                .end((error, res) => {
